...
<div id="layoutSidenav_content">
 <main>
  <div class="container-fluid">
   <h1 class="mt-4">Approved Members</h1>
    ...
    <div class="col-xl-12 col-md-12">
     <div class="card card-outline-secondary  bg-white text-dark mb-4">
      <div class="card-header">
       <h6 class="mb-0">Approved Members Pending Payment</h6>
      </div>
      <div class="card-body">
       <table class="table  table-responsive table-bordered">
        ...
        <tbody>
         <!-- All Pending Approval Member View -->
         <?php 
          $query="SELECT member.id as ID, fname,lname, email, mnumber,agencytype,agency,jobtitle,registrationdate,memtype,memstatus FROM member LEFT JOIN agencytype on member.agencytypecode=agencytype.id LEFT JOIN memtype on member.memtypecode=memtype.id LEFT JOIN memstatus on member.memstatuscode=memstatus.id where member.memstatuscode='2' order by member.id";
         ...
         <tr>
          ...
          <td>
           <a href="index.php?editId=<?php echo $id; ?>" data-toggle="tooltip" title="Payment Received"><i
             class="fa fa-money" style="color:#85bb65;"></i></a>
           <!-- <a href="index.php?deleteId=<?php echo $id; ?>" data-toggle="tooltip" title="Delete Member"><i
